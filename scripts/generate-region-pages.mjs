...
const defs = [
  { id:'southeast', slug:'southeast-michigan' },
  { id:'west', slug:'west-michigan' },
  ...
  { id:'centralup', slug:'central-upper-peninsula' },
  { id:'keweenaw', slug:'keweenaw-houghton-calumet' },
  { id:'westernup', slug:'western-upper-peninsula' }
];
...
function regionData(def) {
  ...
  const blurb = strip(section.match(/<p class="region-blurb">([\s\S]*?)<\/p>/)?.[1] || 'Michigan cross-country ski trail systems.');
  ...
  const regionTrails = ids.map(id => {
    ...
    return { ...trail, classic: chips.some(c => c.toLowerCase().includes('classic')) || trail.cat !== 'backcountry' };
  });
...
function page(region) {
  ...
  return `<!DOCTYPE html><html lang="en"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><title>${esc(title)}</title><meta name="description" content="${esc(description)}"><link rel="canonical" href="${url}"><link rel="author" href="https://chrisizworski.com/chris-izworski/"><meta property="og:type" content="website"><meta property="og:title" content="${esc(title)}"><meta property="og:description" content="${esc(description)}"><meta property="og:url" content="${url}"><meta property="og:image" content="https://xcski.chrisizworski.com/og.png"><meta name="twitter:card" content="summary_large_image"><link rel="icon" href="/favicon.svg" type="image/svg+xml"><link rel="apple-touch-icon" href="/apple-touch-icon.png"><link rel="preconnect" href="https://fonts.googleapis.com"><link rel="preconnect" href="https://fonts.gstatic.com" crossorigin><link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz,wght@12..96,400;12..96,600;12..96,800&family=Public+Sans:wght@400;500;600;700&display=swap" rel="stylesheet"><link rel="stylesheet" href="/region-page.css"><script type="application/ld+json">${js(schema)}</script></head><body><header class="region-top"><div class="region-wrap"><a href="/">← Michigan XC Ski Trails &amp; Nordic Board</a></div></header><main class="region-wrap"><section class="region-hero"><p class="region-kicker">Regional Michigan Nordic Board</p><h1>${esc(region.title)}</h1><p>${esc(region.blurb)}</p></section><section class="region-panel"><div class="region-board-head"><div><h2>Best skiing signals today</h2><p id="region-freshness" class="region-freshness">Loading regional snow, surface, and confidence intelligence…</p></div><span id="region-board-state" class="region-state">Loading…</span></div><div class="region-filters"><button data-region-filter="all" aria-pressed="true">Best today</button><button data-region-filter="groomed" aria-pressed="false">Groomed</button><button data-region-filter="classic" aria-pressed="false">Classic</button><button data-region-filter="skate" aria-pressed="false">Skate</button><button data-region-filter="rentals" aria-pressed="false">Rentals</button></div><div id="region-board"><div class="region-empty">Building regional board…</div></div></section><section class="region-panel"><h2>${esc(region.trails.length)} trails in this region</h2><div class="region-trails">${cards}</div></section></main><footer class="region-footer"><div class="region-wrap">Regional board within <a href="/">Michigan XC Ski Trails</a>. Weather from Open-Meteo; grooming/status provenance stays separate from modeled snow and surface guidance.</div></footer><script>window.REGION_TRAILS=${js(region.trails)};</script><script src="/xc-intelligence.js" defer></script><script src="/region-page.js" defer></script></body></html>`;
}
...
console.log(`Generated ${regions.length} statewide regional XC intelligence boards.`);
